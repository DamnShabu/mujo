...
QtObject {
    ...
    readonly property var defaults: ({
        ...
        // Global desktop widget styling defaults
        "desktop.widgets.glassOpacity": 0.82,
        "desktop.widgets.radius": 16,
        "desktop.widgets.shadows": true,
        "desktop.widgets.borderGlow": true,
        // Desktop per-widget default settings
        "desktop.clock.format24": true,
        "desktop.clock.showSeconds": false,
        "desktop.clock.showDate": true,
        "desktop.clock.dateFormat": "full",
        "desktop.clock.style": "glass",
        "desktop.clock.alignment": "center",
        "desktop.weather.style": "standard",
        "desktop.weather.units": "metric",
        "desktop.weather.showCity": true,
        "desktop.weather.showCondition": true,
        "desktop.sysmon.style": "bars",
        "desktop.sysmon.showCpu": true,
        "desktop.sysmon.showMem": true,
        "desktop.sysmon.refreshSec": 3,
        "desktop.media.style": "standard",
        "desktop.media.showControls": true,
        "desktop.media.showArtist": true,
        "desktop.notes.theme": "slate",
        "desktop.notes.fontSize": "medium",
        "desktop.photo.interval": 0,
        "desktop.photo.fitMode": "crop",
        "desktop.vpn.style": "standard",
        "desktop.vpn.showLocation": true,
        "desktop.aiusage.provider": "",
        "desktop.aiusage.showGauges": true,
        "desktop.calendar.showWeekNumbers": false,
        // Bar widget style settings
        "bar.clock.format24": true,
        "bar.clock.showSeconds": false,
        "bar.clock.showDate": true,
        "bar.clock.dateFormat": "short",
        "bar.clock.fontMono": true,
        "bar.clock.bold": false,
        "bar.clock.showIcon": false,
        "bar.launcher.icon": "search",
        "bar.launcher.showLabel": false,
        "bar.launcher.label": "Apps",
        "bar.workspaces.style": "numbers",
        "bar.workspaces.gliderStyle": "morphic",
        "bar.workspaces.showWindowDots": true,
        "bar.workspaces.hideEmpty": false,
        "bar.activeWindow.showIcon": true,
        "bar.activeWindow.showTitle": true,
        "bar.activeWindow.maxWidth": 190,
        "bar.activeWindow.style": "pill",
        "bar.volume.showPercent": false,
        "bar.volume.step": 5,
        "bar.battery.showPercent": "charging",
        "bar.battery.lowThreshold": 20,
        "bar.network.showSsid": false,
        "bar.bluetooth.showDevice": false,
        "bar.notifications.showCount": true,
        "bar.llm.showTokens": false,
        "bar.session.iconStyle": "power",
