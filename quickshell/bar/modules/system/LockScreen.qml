...
WlSessionLock {
    ...
    WlSessionLockSurface {
        ...
        ColumnLayout {
            ...
            // Attempts / error line. Kept in the layout at all times and faded
            // in — toggling `visible` re-centres the whole column, so the clock
            // and field jumped upward the moment an attempt failed.
            Text {
                Layout.alignment: Qt.AlignHCenter
                opacity: Lock.attempts > 0 ? 1 : 0
