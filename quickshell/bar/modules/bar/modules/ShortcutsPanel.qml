...
Item {
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ColumnLayout {
                spacing: 3
                Text { text: "Keyboard Shortcuts"; color: Theme.text; font.family: Theme.fontFamily; font.pixelSize: Theme.fontSizeTitle + 7; font.bold: true }
                Text { text: root.binds.length + " bindings from the live niri config."; color: Theme.textSecondary; font.family: Theme.fontFamily; font.pixelSize: Theme.fontSizeBody }
            }
