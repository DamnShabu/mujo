        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    Text {
                        text: "Arrange monitors, set resolution, refresh rate, and scale."
            ...
            Rectangle {
                ...
                Item {
                    ...
                    readonly property var enabled: root.outputs.filter(function(o) { return o.on })
                    readonly property real minX: enabled.length ? Math.min.apply(null, enabled.map(function(o) { return o.x })) : 0
                    readonly property real minY: enabled.length ? Math.min.apply(null, enabled.map(function(o) { return o.y })) : 0
                    readonly property real maxX: enabled.length ? Math.max.apply(null, enabled.map(function(o) { return o.x + o.lw })) : 1920
                    readonly property real maxY: enabled.length ? Math.max.apply(null, enabled.map(function(o) { return o.y + o.lh })) : 1080
                    ...
                    Text {
                        anchors.centerIn: parent
                        visible: canvas.enabled.length === 0
