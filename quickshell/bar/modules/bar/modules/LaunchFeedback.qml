...
PanelWindow {
    ...
    Rectangle {
        ...
        Behavior on opacity { NumberAnimation { duration: Theme.reduceMotion ? 0 : Theme.durationFast; easing.type: Easing.OutQuad } }

        transform: Translate {
            y: fb.shown ? 0 : 14
            Behavior on y { NumberAnimation { duration: Theme.reduceMotion ? 0 : Theme.durationSlow; easing.type: Easing.OutCubic } }
        }
