...
// Devices: keyboard + pointer input. These are niri config, not runtime-settable
// via `niri msg`, so changes are written to the niri-settings.json source of
// truth (via `mujo niri input set`) and applied by a rebuild. The panel tracks a
// dirty flag and surfaces a rebuild banner.
Item {
    id: root
    ...
    Flickable {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                ColumnLayout {
                    spacing: 3
                    Text { text: "Devices"; color: Theme.text; font.family: Theme.fontFamily; font.pixelSize: Theme.fontSizeTitle + 7; font.bold: true }
                    Text { text: "Keyboard and pointer input."; color: Theme.textSecondary; font.family: Theme.fontFamily; font.pixelSize: Theme.fontSizeBody }
                }
            ...
            // ── Keyboard ──────────────────────────────────────────────────────
            RowLayout { spacing: 10; BrandIcon { brand: "keyboard"; size: 26 }
                Text { text: "Keyboard"; color: Theme.text; font.family: Theme.fontFamily; font.pixelSize: Theme.fontSizeTitle + 2; font.bold: true } }
            ...
            // ── Mouse ─────────────────────────────────────────────────────────
            RowLayout { spacing: 10; BrandIcon { brand: "mouse"; size: 26 }
                Text { text: "Mouse"; color: Theme.text; font.family: Theme.fontFamily; font.pixelSize: Theme.fontSizeTitle + 2; font.bold: true } }
            ...
            // ── Touchpad ──────────────────────────────────────────────────────
            RowLayout { spacing: 10; MaterialIcon { iconName: "touch_app"; pixelSize: 22; color: Theme.accent }
                Text { text: "Touchpad"; color: Theme.text; font.family: Theme.fontFamily; font.pixelSize: Theme.fontSizeTitle + 2; font.bold: true } }
