...
Item {
    ...
    ColumnLayout {
        ...
        RowLayout {
            spacing: 14
            BrandIcon { brand: "nixos"; size: 44 }
            ColumnLayout {
                spacing: 2
                Text { text: "System / NixOS"; color: Theme.text; font.family: Theme.fontFamily; font.pixelSize: Theme.fontSizeTitle + 7; font.bold: true }
                Text { text: "Generations, rebuild, updates, and store maintenance."; color: Theme.textSecondary; font.family: Theme.fontFamily; font.pixelSize: Theme.fontSizeBody }
            }
        }
