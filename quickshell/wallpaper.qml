...
Variants {
  ...
  Item {
    ...
    PanelWindow {
        ...
        stdout: StdioCollector {
          onStreamFinished: {
            try {
              ...
              root.zoomEnabled = !!(c.effects && c.effects.zoom)
              root.panEnabled = !!(c.effects && c.effects.pan)
      ...
      Item {
        ...
        transform: [
          ...
          Translate {
            id: zoomTranslate
            x: root.panEnabled && root.zoomEnabled ? (screen.smoothX - 0.5) * root.width * -0.1 : 0
            y: root.panEnabled && root.zoomEnabled ? (screen.smoothY - 0.5) * root.height * -0.1 : 0
          }
        ]
      }
    }
    ...
    Process {
      ...
      running: root.zoomEnabled && root.panEnabled
